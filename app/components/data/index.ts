...
export const gridItems = [
...

  {
    ...
    imgClassName:
      "absolute right-0 bottom-0 md:w-96 w-60 opacity-50 rounded-lg",
    titleClassName:
      "justify-center md:justify-start lg:justify-center w-full sm:max-w-2/3",
    img: "/b5.png",
    spareImg: "/grid.svg",
  },
  {
...
export const projects = [
  {
    ...
    link: "https://ai-summarizer-yqgi.vercel.app/",
  },
  {
    id: 2,
    title: "YC Directory",
    ...
    link: "https://yc-directory-beta-ten.vercel.app/",
  },
  {
    id: 3,
    ...
    link: "https://movio-iota.vercel.app/",
  },
  {
    id: 5,
    title: "غزة ما بعد السابع من أكتوبر ",
    des: "A news website specializing in news of the genocide in Gaza that occurred after October 7th, as it includes several news items and videos to cover what is happening there.",
    img: "/p6.png",
    iconLists: [
      "/next.svg",
      "/tail.svg",
    ...
    link: "https://gaza-voices-unforgotten-git-main-ahmeds-projects-c69b50f2.vercel.app/",
  },
  {
    id: 4,
    ...
    img: "/p5.jpg",
    iconLists: ["/re.svg", "/tail.svg", "/shadcn.png", "/framer.svg"],
    link: "https://portfolio-ahmed-blond.vercel.app/",
  },
];
