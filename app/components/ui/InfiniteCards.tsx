  ...
  return (
    ...
    >
      <ul
        ref={scrollerRef}
        className={cn(
          "flex w-max min-w-full shrink-0 flex-nowrap gap-12 md:gap-16 py-4",
      ...
      >
        {items.map((item, idx) => (
          <li
            className="relative w-[70vw] max-w-full shrink-0 rounded-2xl border border-b-0   p-5 md:p-16 md:w-[60vw]
             border-zinc-800 "
             style={{
              //   add these two
